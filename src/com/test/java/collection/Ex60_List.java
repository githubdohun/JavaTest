...
public class Ex60_List {
	...
	private static void m6() {
		...
		ArrayList<Integer> list = new ArrayList<Integer>(10); 	//(10) 배열 방 고정
	...
	private static void m3() {
		...
		ArrayList<ArrayList<Integer>> ms2 = new ArrayList<ArrayList<Integer>>();	//2차원 배열
		
		ArrayList<ArrayList<ArrayList<Integer>>> ms3 = new ArrayList<ArrayList<ArrayList<Integer>>>(); //3차원 배열
	...
	private static void m2() {
		...
		String temp = list.set(2, "포도");	//2번째 방에 있는 값을 포도로 고친다
		...
		// - boolean remone(T value) - 값을 찾아서 삭제
		// - *** shift 발생 > 삭제된 방 이후의 모든 요소는 방번호 - 1 감소
		...
		//10.
		System.out.println(list.isEmpty()); //is로 시작하면 true false
