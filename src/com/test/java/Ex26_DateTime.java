...
public class Ex26_DateTime {
	...
	private static void m6() {
		...
		System.out.println(nowTick); //1689898997431 (ms)
		...
		long christmastick = end.getTimeInMillis();
	...
	private static void m3() {
		...
		//특정 시각을 생성하기 > 원하는 시간 생성 > 올해 크리스마스 
	...
	private static void m2() {
		...
		System.out.println(c1.get(1));//2023, 1 = 년도
		...
		System.out.println(c1.get(Calendar.YEAR)); //최종 형태, 실제 사용 예
		...
		System.out.println(c1.get(Calendar.YEAR)); //최종 형태, 실제 사용 예 2023년
		System.out.println(c1.get(Calendar.MONTH)); // 6월 (0부터 시작)
		System.out.println(c1.get(Calendar.DATE)); // 20일
		System.out.println(c1.get(Calendar.HOUR)); // 4 > 12시간
		System.out.println(c1.get(Calendar.HOUR_OF_DAY)); // 16 > 24시간
		...
		System.out.println(c1.get(Calendar.DAY_OF_YEAR)); // 201일 > 365
		System.out.println(c1.get(Calendar.DAY_OF_MONTH)); // 20일
		System.out.println(c1.get(Calendar.DAY_OF_WEEK)); // 5 > 1 (일요일) ~ 7 (토요일)
		System.out.println(c1.get(Calendar.WEEK_OF_YEAR)); // 29주
		System.out.println(c1.get(Calendar.WEEK_OF_MONTH)); // 4주
		System.out.println();
		...
		//지금은 17시 05분 50초입니다. 24시간
		//지금은 오후 5시 05분 50초입니다. 12시간
