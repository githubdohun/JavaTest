...
public class Ex57_Generic {
	...
	public static void main(String[] args) {
		...
		//String 중심으로 하는 클래스 설계 + 나머지 업무는 동일
		//boolean 중심으로 하는 클래스 설계 + 나머지 업무는 동일
		//double 중심으로 하는 클래스 설계 + 나머지 업무는 동일
		//byte 중심으로 하는 클래스 설계 + 나머지 업무는 동일 .......
		...
		//** 절대 > 값형과 참조형간의 형변환 불가능!!
		
		//Object 변수 == 만능 주머니 (모든 자료형을 담을 수 있는 변수)
		Object o1 = new Object();
		Object o2 = new Hong(); //Up Casting
