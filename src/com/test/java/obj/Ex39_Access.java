	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 접근 지정자 (제어자), Acess Modifier
		 	...
		 	- 클래스 자체에 붙여서 사용한다.
		 	- 지역 변수에는 사용이 불가능하다.
		 	- 클래스(객체)의 영역을 기준으로, 외부에 해당 멤버를 어떻게 노출할 지 통제하는 역할 > 보안 수준 제어
...
//			System.out.println(book.price);
			...
			//System.out.println("책 가격: " + book.ccc() + "원");//읽기 > Getter
...
//			
		// System.out.printf("마우스 제조년월일: %tF\n", m1.getDate());
			...
			//m1의 현재 모든 상태 확인? 개발자가 객체의 상태를 확인하고 싶을 때 사용하는 메소드 > dump
