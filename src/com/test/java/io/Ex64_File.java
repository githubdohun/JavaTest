...
//			}
	...
	private static void m9() {
		//날짜별 폴더 ex) 2023-01-01 ~ 2023-12-31
	...
	private static void m7() {
		...
		if(!dir.exists()) {
			...
			System.out.println(dir.mkdirs());	//연관된 폴더 모두 함꼐
	...
	private static void m5() {
		...
		if(!file.exists()) {
			...
			System.out.println(file.renameTo(file2)); //경로와 이름을 한 번에 바꿀 수 있음.
	...
	private static void m2() {
		...
		if (dir.exists()) {
			...
			System.out.println(dir.length());	//0 파일 크기	//당사자 자신
	...
	private static void m1() {
		...
		if (file.exists()) {
			...
			System.out.println(file.length());	//34 파일 크기
			System.out.println(file.getAbsolutePath());	//C:\class\code\java\file\data.txt //경로
			
			System.out.println(file.lastModified());	//1691379527428	//수정한 날짜
