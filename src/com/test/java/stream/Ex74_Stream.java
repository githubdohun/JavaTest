...
public class Ex74_Stream {
	...
	public static void main(String[] args) {
		...
		//System.err.println(mf.getFileNameWithoutExtension(path));
	...
	private static void m9() {
		...
		// a. boolean allMatch (Predicate) > 모든 요소가 조건을 100% 만족 AND
	...
	private static void m7() {
		...
		slist.add(new Student("나나나", 80, 70, 70));
		slist.add(new Student("다다다", 80, 90, 80));
		slist.add(new Student("라라라", 86, 83, 87));
		slist.add(new Student("마마마", 55, 56, 50));
	...
	private static void m5() {
		...
		.filter(user -> user.getGender() == 1) //AND 일때만 가능 앞에 필터를 만족해야 뒤로 넘어옴
	...
	private static void m1() {
		...
		int[] nums2 = Data.getIntArray();
		System.out.println(Arrays.toString(nums2));
		
		java.util.List<Integer> nums3 = Data.getIntList();
		System.out.println(nums3.size()); 
		
		java.util.List<Integer> nums4 = Data.getIntList();
...
class Cup {
	...
	private String color2; //주관식 > color= "white"
